...
class TipsViewController: UIViewController {
    ...
    func initalizeTips() {
        let reviewtip = "Thank you for your time in reviewing my MemeMe 2.0 Project. \nI have used the Grading rubric to complete all the items but due i wanted to add my own ideas to the app and i have change few of the UI elements from requirements and i hope that will be okay. Hope you like what you see from here!!"
